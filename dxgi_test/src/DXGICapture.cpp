...
DxgiCapture::DxgiCapture():m_DeskDupl(nullptr),m_AcquiredDesktopImage(nullptr),m_OutputNumber(0),m_Device(nullptr)
{
}
...
bool DxgiCapture::GetFrame(int timeout)
{
...
bool DxgiCapture::copyFrameDataToBuffer(BYTE** buffer, int & width, int & height)
{
	HRESULT hr;
...
//init duplication
bool DxgiCapture::InitDupl(UINT Output)
{
