...
const ::uint32_t
    TableStruct_helloworld_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::HelloReply, _impl_.info_),
};
...
const char descriptor_table_protodef_helloworld_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "essage\030\001 \001(\t\022\014\n\004info\030\002 \001(\t23\n\007Greeter\022(\n"
    "\010SayHello\022\r.HelloRequest\032\013.HelloReply\"\000b"
    "\006proto3"
};
...
const ::_pbi::TcParseTable<1, 2, 0, 25, 2> HelloRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // int32 age = 2;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(HelloRequest, _impl_.age_), 63>(),
     {16, 63, 0, PROTOBUF_FIELD_OFFSET(HelloRequest, _impl_.age_)}},
    // string name = 1;
    ...
    // int32 age = 2;
    {PROTOBUF_FIELD_OFFSET(HelloRequest, _impl_.age_), 0, 0,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 30, 2> HelloReply::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    2, 8,  // max_field_number, fast_idx_mask
    ...
    // string info = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(HelloReply, _impl_.info_)}},
    // string message = 1;
    {::_pbi::TcParser::FastUS1,
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // string info = 2;
    {PROTOBUF_FIELD_OFFSET(HelloReply, _impl_.info_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* HelloReply::_InternalSerialize(
          ...
          if (!this_._internal_info().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "HelloReply.info");
