...
inline ::int32_t HelloRequest::age() const {
  // @@protoc_insertion_point(field_get:HelloRequest.age)
  return _internal_age();
}
inline void HelloRequest::set_age(::int32_t value) {
  _internal_set_age(value);
  // @@protoc_insertion_point(field_set:HelloRequest.age)
}
...
// string info = 2;
inline void HelloReply::clear_info() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.info_.ClearToEmpty();
}
inline const std::string& HelloReply::info() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:HelloReply.info)
  return _internal_info();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void HelloReply::set_info(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.info_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:HelloReply.info)
}
inline std::string* HelloReply::mutable_info() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_info();
  // @@protoc_insertion_point(field_mutable:HelloReply.info)
  return _s;
}
inline const std::string& HelloReply::_internal_info() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.info_.Get();
}
inline void HelloReply::_internal_set_info(const std::string& value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.info_.Set(value, GetArena());
}
inline std::string* HelloReply::_internal_mutable_info() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.info_.Mutable( GetArena());
}
inline std::string* HelloReply::release_info() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:HelloReply.info)
  return _impl_.info_.Release();
}
inline void HelloReply::set_allocated_info(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ...
  // @@protoc_insertion_point(field_set_allocated:HelloReply.info)
}
